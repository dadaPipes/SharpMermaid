...
public class ClassDiagramTests(ITestOutputHelper output)
{
    ...
    public void Should_Generate_Class_Diagram_With_Single_Class()
    {
        ...
        var diagrams = mermaidGenerator.ClassDiagrams();
        ...
        var expectedDiagrams = new Dictionary<string, string>
        {
            ["ProjectA"] =
            $"""
            ```mermaid
        ...
        foreach (var project in expectedDiagrams.Keys)
        {
            _output.WriteLine($"Checking {project}");
            _output.WriteLine("Expected:\n" + expectedDiagrams[project]);
            _output.WriteLine("Actual:\n" + diagrams[project]);

            Assert.Equal(expectedDiagrams[project], diagrams[project]);
        }
    }
}
